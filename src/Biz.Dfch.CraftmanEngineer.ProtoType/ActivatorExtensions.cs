...
namespace Biz.Dfch.CraftmanEngineer.ProtoType
{
    ...
    {
        private static readonly Lazy<TypeResolver> _types = new Lazy<TypeResolver>();
        ...
        public static object GetInstance(string typeName)
        {
            ...
            var type = _types.Value.Types.FirstOrDefault(e => e.FullName == typeName);
            Contract.Assert(null != type, typeName);
